  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-black text-[#0B1668]">Tontines</h1>
          <p className="text-gray-400 text-sm mt-0.5">Gestion des groupes de tontine</p>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-16 text-center">
        ...
        <h3 className="text-[#0B1668] font-bold text-lg mb-2">Module Tontine</h3>
        <p className="text-gray-400 text-sm max-w-sm mx-auto leading-relaxed">
          La gestion des tontines sera disponible prochainement. Les groupes de tontine seront listés et administrés ici.
        </p>
